...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1Ijoibm9vYm5vYmUiLCJhIjoiY2xraG43dWE2MGVlczNna2VraTF3cXU5MiJ9.0DMEk8PBRRROgOg_ihQb4A';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/noobnobe/clkhog7ny008v01pceqg71h5t',
    scrollZoom: false
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://localhost:3000/api/v1/users/updatePassword' : 'http://localhost:3000/api/v1/users/';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
var resetPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, url) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(res.data.message, "...Redirecting to login page"));
            window.setTimeout(function () {
...
var userResetPasswordForm = document.querySelector('.form--resetPassword');
// DELEGATION
if (mapBox) {
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  //formdata is a built-in browser API to create form data
...
if (userResetPasswordForm) userResetPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          document.querySelector('.btn--green').textContent = 'Reset';
        case 6:
        case "end":
          return _context2.stop();
      }
